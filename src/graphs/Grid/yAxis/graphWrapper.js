...
import YAxisGraph from './YAxis.graph';
...
const YAxis = (props) => {
  ...
  useEffect(() => {
    ...
    if (props.data) {
      if (!graph) {
        graphRef.current = new YAxisGraph(refElement.current);
  ...
  return (
    <GraphContainer className="y-axis-wrp graph-container">
...
export default ResizeHandlerHOC(YAxis);
